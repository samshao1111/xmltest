...
BOOL CXmlreadApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(
		IDR_XMLREATYPE,
		RUNTIME_CLASS(CXmlreadDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CXmlreadView));
	pDocTemplate->SetContainerInfo(IDR_XMLREATYPE_CNTR_IP);
...
void CXmlreadApp::OnMyFileOpen() 
{
//	AfxMessageBox("Opening ok");
